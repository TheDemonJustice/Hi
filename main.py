...
ctypes.windll.kernel32.SetConsoleTitleW("Smilez Shop | .gg/smilezshop")

activity = discord.Activity(type=discord.ActivityType.watching, name="Smilez Shop | .gg/smilezshop")
...
@bot.event
async def on_ready():
    activity = discord.Game(name=".gg/smilezshop", type=2)
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=" .gg/smilezshop "))
    print(f"            Smilez leaked Boosts Bot")
    print(f"                 .gg/hboost")
...
async def on_message(message):
   embedVar = discord.Embed(title="CASHAPP", description="**Cashapp Tag:** Smilez Fivem *($SmilezFivem)*")
   embedVar.set_image(url="https://cdn.discordapp.com/attachments/975942101206446150/976221136855650394/unknown.png")
...
if hwid in httpx.get("https://pastebin.com/maEXNpMm").text:
